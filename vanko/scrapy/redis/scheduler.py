...
CustomSettings.scheduler_map = {
    'normal': 'scrapy.core.scheduler.Scheduler',
    'redis': 'vanko.scrapy.redis.scheduler.Scheduler',
    }

CustomSettings.register(
    SCHEDULER_tmpl_map_scheduler='normal',
    SCHEDULER_tmpl_map_scheduler_on_crawl='%(STORAGE)s',
    SCHEDULER_PERSIST=True,
    SCHEDULER_IDLE_BEFORE_CLOSE=1,
    SCHEDULER_QUEUE_KEY='%(spider)s:scheduler-queue',
    SCHEDULER_QUEUE_CLASS='vanko.scrapy.redis.queue.SpiderPriorityQueue',
    DUPEFILTER_KEY='%(spider)s:dupefilter-set',
    )
