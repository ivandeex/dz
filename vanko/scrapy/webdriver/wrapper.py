...
from .. import RedisUserAgentMiddleware, CustomSettings
...
class WebdriverWrapper(object):
    ...
    def _proxy_workaround():
        ...
        """
        if 'http_proxy' in os.environ and 'no_proxy' not in os.environ:
    ...
    def get_webdriver(self, browser=None, spider=None):
        ...
        user_agent = RedisUserAgentMiddleware.get_global_user_agent(spider)
